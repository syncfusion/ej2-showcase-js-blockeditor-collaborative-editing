(function (App) {
    ...
    function Header(container) {
        container.innerHTML = [
            ...
            '        <a href="https://ej2.syncfusion.com/javascript/documentation/block-editor/es5-getting-started" target="_blank" class="nav-link">Docs</a>',
            '        <a href="https://ej2.syncfusion.com/demos/#/material3/block-editor/overview" target="_blank" class="nav-link">Demos</a>',
            '      </nav>',
            '    </div>',
            '    <div class="header-right">',
            '      <a title="Github Repo" href="https://github.com/syncfusion/ej2-showcase-js-blockeditor-collaborative-editing" class="social-link" target="_blank">',
            ...
            '        </svg>',
            '      </a>',
            '      <a title="Npm package" href="https://www.npmjs.com/package/@syncfusion/ej2-blockeditor" class="social-link" target="_blank">',
